...
/* Audio - I2S for NS4168 Speaker */
#define BSP_NS4168_CTRL_PIN   (GPIO_NUM_31)  // NS4168控制引脚（声道和电源控制）
#define BSP_NS4168_LRCLK_PIN  (GPIO_NUM_32)  // NS4168 LRCLK（WS）
#define BSP_NS4168_BCLK_PIN   (GPIO_NUM_33)  // NS4168 BCLK（BCK）
#define BSP_NS4168_SDATA_PIN  (GPIO_NUM_34)  // NS4168 SDATA（DATA_OUT）

/* Audio - PDM for MSM261D Microphone */
#define BSP_PDM_CLK           (GPIO_NUM_26)  // PDM时钟
#define BSP_PDM_DATA          (GPIO_NUM_27)  // PDM数据

/* Power */
#define BSP_BL_LCD1V8             (GPIO_NUM_4)
 ...
 *  Note: NS4168 (speaker) and MSM261D (microphone) do not use I2C
 **************************************************************************************************/
 ...
 *
 * Audio devices:
 *  - NS4168: I2S codec for output(playback) path
 *  - MSM261D: PDM microphone for input(recording) path
 *
 ...
 *
 * Note: MSM261D is a PDM microphone that doesn't require a codec chip.
 * This function initializes the PDM interface but returns NULL.
 * Use i2s_channel_read() directly to read audio data.
 * 
 * @return NULL (MSM261D doesn't support esp_codec_dev API, use i2s_channel_read directly)
 */
esp_codec_dev_handle_t bsp_audio_codec_microphone_init(void);

/**
 * @brief Get I2S RX channel handle for MSM261D PDM microphone
 *
 ...
 *
 * Note: NS4168 is an I2S digital audio amplifier that doesn't require a codec chip.
 * This function initializes the I2S interface but returns NULL.
 * Use i2s_channel_write() directly to play audio.
 * 
 * @return NULL (NS4168 doesn't support esp_codec_dev API, use i2s_channel_write directly)
 */
esp_codec_dev_handle_t bsp_audio_codec_speaker_init(void);

/**
 * @brief Get I2S TX channel handle for NS4168 speaker
 *
